...
const translations = {
  en: {
    ...
    'projects.ticketsystem.title': 'Ticket System',
    'projects.ticketsystem.description': 'Complete customer support platform inspired by Zendesk, with ticket management, priority queues, agent assignment, and real-time status tracking.',
    'projects.ticketsystem.tech': 'React, Node.js, PostgreSQL, Socket.io',
    'projects.smtpplatform.title': 'SMTP Platform',
    'projects.smtpplatform.description': 'Email sending platform with SMTP server management, campaign dashboard, delivery tracking, and bounce handling.',
    'projects.smtpplatform.tech': 'Next.js, Node.js, Redis, Docker',
    ...
    'projects.fitnesslps.title': 'Fitness Landing Pages',
    'projects.fitnesslps.description': 'Collection of high-converting landing pages for fitness brands, with responsive design, lead capture forms, and performance optimization.',
    'projects.fitnesslps.tech': 'Next.js, Tailwind CSS, TypeScript',
  ...
  pt: {
    ...
    'projects.ticketsystem.title': 'Sistema de Tickets',
    'projects.ticketsystem.description': 'Plataforma completa de suporte ao cliente inspirada no Zendesk, com gestão de tickets, filas de prioridade, atribuição de agentes e rastreamento de status em tempo real.',
    'projects.ticketsystem.tech': 'React, Node.js, PostgreSQL, Socket.io',
    'projects.smtpplatform.title': 'Plataforma SMTP',
    'projects.smtpplatform.description': 'Plataforma de envio de e-mails com gerenciamento de servidores SMTP, dashboard de campanhas, rastreamento de entregas e tratamento de bounces.',
    'projects.smtpplatform.tech': 'Next.js, Node.js, Redis, Docker',
    ...
    'projects.helpcenter.tech': 'React, Node.js, MongoDB, REST API',
    'projects.fitnesslps.title': 'Landing Pages Fitness',
    'projects.fitnesslps.description': 'Coleção de landing pages de alta conversão para marcas fitness, com design responsivo, formulários de captação de leads e otimização de performance.',
    'projects.fitnesslps.tech': 'Next.js, Tailwind CSS, TypeScript',
  ...
  es: {
    ...
    'projects.ticketsystem.title': 'Sistema de Tickets',
    'projects.ticketsystem.description': 'Plataforma completa de soporte al cliente inspirada en Zendesk, con gestión de tickets, colas de prioridad, asignación de agentes y seguimiento de estado en tiempo real.',
    'projects.ticketsystem.tech': 'React, Node.js, PostgreSQL, Socket.io',
    'projects.smtpplatform.title': 'Plataforma SMTP',
    'projects.smtpplatform.description': 'Plataforma de envío de emails con gestión de servidores SMTP, dashboard de campañas, seguimiento de entregas y manejo de rebotes.',
    'projects.smtpplatform.tech': 'Next.js, Node.js, Redis, Docker',
    ...
    'projects.helpcenter.tech': 'React, Node.js, MongoDB, REST API',
    'projects.fitnesslps.title': 'Landing Pages Fitness',
    'projects.fitnesslps.description': 'Colección de landing pages de alta conversión para marcas fitness, con diseño responsivo, formularios de captación de leads y optimización de rendimiento.',
    'projects.fitnesslps.tech': 'Next.js, Tailwind CSS, TypeScript',
